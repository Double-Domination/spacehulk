...
class Developer {
	...
	getDevStats() {
		return console.log(
			this.firstName + " " + this.lastName + " " + this.devProficiency,
		);
	}
}
...
function callSignForRepl() {
	console.log(" Callsign sucsessfull!");
}
...
* */
	...
	return (
		<div className='standard-unit-card'>
...
function callsignFunction(callsign) {
	return callsign;
}
